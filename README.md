...
In the prototype, all you need to develop is an import script, a map view and a small simulation service. The simulation service helps wind turbine planners plan the proper layout of wind turbines in an area.
...
- Your UI has to use the provided images/icons for visualization.
...
1. In the first part, you will develop a script to import maps.
2. In the second part, you will develop a map view.
3. In the third part, you will extend the map view with a basic simulation service.
...
1. To submit your work, you will need to share a GitHub repository (hereafter referred to as repo) containing the source code of your solution. We prefer that executable files or built solution are included in your repo too. If you have not used GitHub before, you can register an account at https://github.com and then create a private repo as `es2027-s09-r1-YYY`, where `YYY` is the three-digit number we have emailed you. You then need to share the repo containing your solution with us. To do this, use our GitHub id `skillsithu`.
2. Just in case, send the link of your repo to es2027s09@skillsit.hu.
4. Your README file has to contain the instructions how to start your project backend and frontend.
5. Submit your work no later than the end of 29 January 2026 (Thursday). 
